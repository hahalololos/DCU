...
def run_attention(mode: str, context_len: int, repeats: int) -> None:
    torch.manual_seed(0)
    ...
    def invoke() -> None:
        unified_attention(
            ...
            k_descale=None,
            v_descale=None,
            seq_threshold_3D=seq_threshold_3d if mode == "ua3d" else None,
            num_par_softmax_segments=num_segments if mode == "ua3d" else None,
    ...
    print(
        f"mode={mode} context={context_len} repeats={repeats} "
...
def main() -> None:
    ...
    parser.add_argument("mode", choices=("ua2d", "ua3d", "llmm1_lm_head"))
    ...
    if args.mode == "llmm1_lm_head":
        ...
        run_attention(args.mode, args.context_len, args.repeats)
